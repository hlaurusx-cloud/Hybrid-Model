...
# ==============================================================================
#  단계 3：모델 학습 (순서 변경: 모델 설정 -> 데이터 분할 -> 학습)
# ==============================================================================
    ...
    if "X_processed" not in st.session_state.data:
        ...
        # -------------------------------------------------------------
        # 2. 모델별 상세 파라미터 설정 (위로 이동됨)
        # -------------------------------------------------------------
        st.markdown("### 2️⃣ 모델별 상세 파라미터 설정")
        ...
        # -------------------------------------------------------------
        # 3. 데이터 분할 및 학습 실행 (아래로 이동됨)
        # -------------------------------------------------------------
        st.markdown("### 3️⃣ 데이터 분할 및 학습 실행")
        
        # [데이터 비율 설정] - 요청하신 대로 모델 설정 아래에 배치
        test_size = st.slider(
            "테스트 데이터 비율 (검증용)", 
            0.1, 0.4, 0.2, 
