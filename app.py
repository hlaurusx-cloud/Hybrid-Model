...
# ==============================================================================
    ...
    if "X_processed" not in st.session_state.data:
        ...
        # -------------------------------------------------------------
        # 2. 데이터 분할 설정 (모델 설정보다 위에 배치)
        # -------------------------------------------------------------
        st.markdown("### 2️⃣ 데이터 분할 (Train/Test Split)")
        ...
        # -------------------------------------------------------------
        # 3. 모델별 상세 파라미터 설정 (데이터 분할 아래에 배치)
        # -------------------------------------------------------------
        st.markdown("### 3️⃣ 모델별 상세 파라미터 설정")
